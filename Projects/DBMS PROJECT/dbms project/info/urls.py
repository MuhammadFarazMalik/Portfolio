...
urlpatterns = [
    ...
    path('get_student_semester/<str:student_id>/', views.get_student_semester, name='get_student_semester'),

    path('library/', views.library_books, name='library_books'),
    path('library/borrow/<str:book_id>/', views.borrow_book, name='borrow_book'),
    path('library/return/<int:loan_id>/', views.return_book, name='return_book'),
    path('degree-status/', views.degree_status, name='degree_status'),
